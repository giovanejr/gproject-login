...
$sql = "SELECT count(*) FROM usrgrp WHERE username = '$_SESSION[username]' AND grpname = 'admin' OR username = '$_SESSION[username]' AND grpname = 'marketresearch'";
...
<html>
	<head>
		...
		<title>Google Project - FileServer - Market Research</title>
		<style type="text/css">
	...
	<body>		
		...
		<header id="header">
			<div id="logo">
				<h1>FileServer: Market Research</h1>
			</div>
			<nav>
				<div class="innertube">
				<ul>
...
<li><select onChange="window.location.href=this.value">
  ...
  <option value="http://188.84.224.35.bc.googleusercontent.com/product.php">ProductDesign</option>
		...
		<main>
			<div class="innertube">
<object type="text/html" data="http://104.197.57.100:8080/elfinder.src.html" width="100%" height="1024px" style="overflow:auto;border:0px ridge blue">
