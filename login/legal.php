...
<html>
	<head>
		...
		<title>Google Project - FileServer - Legal</title>
		<style type="text/css">
...
<li><select onChange="window.location.href=this.value">
  ...
  <option value="http://fserver.gproject.com/market.php">MarketResearch</option>
		...
		<main>
			<div class="innertube">
<object type="text/html" data="http://104.154.189.12:8080/elfinder.src.html" width="100%" height="1024px" style="overflow:auto;border:0px ridge blue">
